...
* **Associated ACAI Concepts:** Saul (ID: `person:Saul.2`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Jabesh-gilead (ID: `place:Jabesh-gilead`); Mount Gilboa (ID: `place:GilboaMount`); Israel (ID: `person:Israel`); Beth-shan (ID: `place:Beth-shan`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); Abinadab (ID: `person:Abinadab.2`); Beth-ashtoreth (ID: `place:Beth-ashtoreth`); Malchi-shua (ID: `person:Malchi-shua`); Jonathan (ID: `person:Jonathan.3`); Ashtoreth (ID: `deity:Ashtoreth`); Fear (ID: `keyterm:Fear`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Jordan River (ID: `place:Jordan`); Tamarisk (ID: `flora:Tamarisk`); Image (ID: `realia:Image`); Bow (ID: `realia:Bow`)
