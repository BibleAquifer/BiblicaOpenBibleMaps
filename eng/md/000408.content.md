...
* **Associated ACAI Concepts:** Elisha (ID: `person:Elisha`); Elijah (ID: `person:Elijah`); LORD (ID: `deity:Lord`); Jericho (ID: `place:Jericho`); Bethel (ID: `place:Bethel`); Jordan River (ID: `place:Jordan`); Clothing (ID: `realia:Clothing`); Chariot (ID: `realia:Chariot`); Gilgal (ID: `place:Gilgal.3`); Israel (ID: `person:Israel`); Men (ID: `group:GenericMales`); Samaria (ID: `place:Samaria`); Mount Carmel (ID: `place:CarmelMount`); Bear (ID: `fauna:Bear`); Horse (ID: `fauna:Horse`); Sandalwood (ID: `flora:Sandalwood`)
